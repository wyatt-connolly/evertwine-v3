              ...
              <table className="min-w-full border border-gray-800">
                <thead>
                  <tr className="bg-gray-900">
                    <th className="py-2 px-4 border-b border-r border-gray-800 text-left text-white">
                      Category
                    </th>
                    <th className="py-2 px-4 border-b border-gray-800 text-left text-white">
                      Examples
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-gray-800">
                    <td className="py-2 px-4 border-r border-gray-800">
                      Identifiers
                    </td>
            ...
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li>
                ...
                <p>
                  ...
                  <br />
                  <em>
                    Our Practice: We do not sell personal data or process it for
