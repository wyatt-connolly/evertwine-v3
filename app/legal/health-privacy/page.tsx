        ...
        <div className="bg-black border border-gray-800 rounded-xl shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none text-gray-300 prose-headings:text-white prose-strong:text-white prose-a:text-blue-400">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Self-Reported Activity Details:</strong> Anything you
                choose to write in your profile or bio about your exercise, step
                counts, wellness routines, or other fitness habits (e.g.,
                &quot;I run 2 miles daily,&quot; &quot;I hit 10,000 steps each
                day&quot;).
              </li>
              <li>
                <strong>No Sensor or Device Data:</strong> We do not
                automatically collect data from wearables, health apps, or
                sensors. All health-related details are provided at your
                discretion.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Within Evertwine:</strong> Your self-written health
                details appear only in your profile and within the app when
                other users view your bio.
              </li>
              <li>
                <strong>No Third-Party Sales:</strong> We never sell or share
                your health-related bio text to advertisers or external
                marketers.
              </li>
              <li>
                <strong>Legal Requests:</strong> Only if required by law (e.g.,
                valid court order) would we disclose any part of your profile
                text, including self-reported health details.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Security Measures:</strong> We encrypt your profile data
                in transit (TLS) and at rest, and restrict internal access to
                authorized staff only.
              </li>
              <li>
                <strong>Retention Period:</strong> We keep your profile text as
                long as your account is active. If you delete your account, we
                remove your profile data within 30 days (aside from brief
                backups which are purged within 90 days).
              </li>
            </ul>
