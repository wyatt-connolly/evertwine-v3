...
export default function HeroSection({ isLoaded }: HeroSectionProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center">
      ...
      <div className="lg:hidden container mx-auto px-8 pt-16">
        <div className="max-w-3xl">
          <h1
            className={`text-white text-6xl font-bold leading-tight tracking-tight opacity-0 ${
          ...
          <p
            className={`text-white/80 text-xl mt-6 max-w-2xl font-light opacity-0 ${
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white px-8 py-3 text-lg font-light hover:bg-white/20 transition-colors"
            >
              Get The App
            </a>
          </div>
          ...
          <div className="w-1/2">
            ...
            >
              <a
                href="#download"
                onClick={(e) => handleNavClick(e, "download")}
                className="inline-flex items-center justify-center rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white px-10 py-4 text-xl font-light hover:bg-white/20 transition-colors"
              >
                Get The App
              </a>
            </div>
