    ...
    <section className="min-h-screen bg-black px-4 lg:px-8 flex items-center">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <h3 className="text-white text-2xl font-bold mb-6">
              🛡️ Safe & Trusted Community (Verification Coming Soon)
            </h3>
            <div className="h-40 w-full relative">
          ...
          {/* Friend Groups & Communities Card */}
          <div
            className={`feature-card rounded-3xl bg-black border border-gray-800 p-6 overflow-hidden transition-all duration-500 hover:border-blue-500 hover:shadow-xl hover:shadow-blue-500/20 transform ${
              isFeatureGridVisible
                ? "opacity-100 translate-y-0"
              ...
              <div className="relative w-full h-full">
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl overflow-hidden">
                  <div className="absolute inset-0">
                    {/* Multiple overlapping circles representing friend groups */}
                    <div className="absolute left-1/4 top-1/3 w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                      <Users className="h-6 w-6 text-white" />
                    </div>
                    <div className="absolute right-1/4 top-1/3 w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                      <Users className="h-6 w-6 text-white" />
                    </div>
                    <div className="absolute left-1/2 bottom-1/3 w-12 h-12 bg-white/30 rounded-full transform -translate-x-1/2 flex items-center justify-center">
                      <Users className="h-6 w-6 text-white" />
                    </div>

                    {/* Connecting lines */}
                    <div className="absolute left-1/4 top-1/2 right-1/4 h-0.5 bg-white/20 transform -translate-y-1/2"></div>
                    <div className="absolute left-1/3 top-1/2 w-0.5 h-8 bg-white/20 transform -translate-x-1/2"></div>
                    <div className="absolute right-1/3 top-1/2 w-0.5 h-8 bg-white/20 transform translate-x-1/2"></div>
                  </div>
                </div>
              </div>
            </div>
