  ...
  const [faqs, setFaqs] = useState<FaqItem[]>([
    {
      ...
      answer:
        "User verification with selfie and government ID is coming soon to ensure genuine, trustworthy connections. Currently, we focus on community guidelines and safety measures.",
      isOpen: false,
    },
    {
      question: "Is Evertwine a dating app?",
      answer:
        "No. Evertwine is designed for building genuine friendships. It's a space to meet new people through real-world meetups and shared interests, not online dating.",
      isOpen: false,
    },
    {
        ...
        <div className="space-y-6 px-2 md:px-0">
          {faqs.map((faq, index) => (
            <div
              ...
              style={{
                transitionDelay: isFaqVisible ? `${index * 150}ms` : "0ms",
              }}
            >
              <button
